...
phis_to_test <- c(0, 0.001, seq(0.01, 0.15, 0.01))
...
for (x_Glc in c(0.001,0.005 ,0.02, 0.1)){
  x_cond[1,1] <- x_Glc
  ...
  for(protein in c(ferm_ind, resp_ind)){
...
legend("topright",
       legend = rev(levels(colors)),
       col = rev(unique(colors)),
       pch = 19, title="Glucose")
