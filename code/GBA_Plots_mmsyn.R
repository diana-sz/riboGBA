...
plot(cx1,mu_opt,pch=16, mgp=c(2, 0.5, 0), col.lab = colorlab, frame.plot=F, col= 1,xlim=c(minx1,maxx1),ylim=c(0,maxmu), xaxt = "n",
     yaxt = "n", ylab=bquote("Growth rate"~ mu ~ (h^-1)), xlab=paste("Concentration", glc,"(g/L)"), yaxs="i", xaxs="i")
...
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=0.02,las=1)
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=-0.02,las=1)
legend("topleft",i_reactant[-p],col=colori,pch=16,cex=0.4)
...
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=0.02,las=1)
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=-0.02,las=1)
legend("topright",reaction,col=colorj,pch=16,cex=0.4)


# Whole ribosome concentration #############################################################################################

rP <-  p_opt[, "p Ribosome"]
RNA <- cm_opt[,which(i_reactant == "rRNA")]
rib <- rP + RNA
...
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=0.02,las=1)
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=-0.02,las=1)
legend("bottomright", "Whole r" ,col=colorj[1],pch=16,cex=0.4)
...
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=0.02,las=1)
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=-0.02,las=1)
legend("bottomright", c("RNA:rP") ,col=colorj[1],pch=16,cex=0.4)



# RP ratios #############################################################################################
total_RNA <- rowSums(cm_opt[, grep("RNA", i_reactant), drop=FALSE])

rp_ratio <- total_RNA/c_opt[,which(i_reactant == "Protein")]
#r_data <- matrix(c(rr_ratio, rp_ratio), ncol=2)
...
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=0.02,las=1)
axis(2, mgp=c(3, 0.4, 0), col=coloraxis, col.ticks=coloraxis, col.axis=coloraxis, tck=-0.02,las=1)
legend("bottomright", c("RNA:Protein") ,col=colorj[1],pch=16,cex=0.4)
